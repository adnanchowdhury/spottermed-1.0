                ...
                <div id="accordion">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                        A first-year medical student currently studying at Barts and The London Medical School in London.
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                          Does this website work on mobile?
                        </button>
                      </h5>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                      <div class="card-body">
                        Yes! This website has been developed to work on all mobile, tablet, laptops and desktop devices.
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                      <div class="card-body">
                        Currently, the questions are organised according to the system-based modules taught at Barts and the London Medical School. More broad-term modules may however be added in the future.
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    <div class="card-header" id="headingFour">
                      <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                          Can I re-do the questions?
                        </button>
                      </h5>
                    </div>
                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                      <div class="card-body">
                        Yes! You can answer the questions as many times as you like. The web application will show each question once during each round until you have seen all the questions in that module. After completing a round of questions, you will receive your total final percentage mark. You may re-do the questions from the beginning again after this.
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    ...
                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                      <div class="card-body">
                        New questions are currently being added on a daily basis ahead of the coming exam season.
                      </div>
                    </div>
                  </div>
