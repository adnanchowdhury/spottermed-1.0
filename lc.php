...
<html lang="en">
  <head>
    ...
    <script>
     $(document).ready(function(){
        if (typeof(Storage) !== "undefined") {
          // Store
          if (localStorage.getItem("LCuserMark") > 0) {
              
        } else {
          localStorage.setItem("LCuserMark", 0);
        }
        } else {
        ...
        if (typeof(Storage) !== "undefined") {
          // Store
          if (localStorage.getItem("LCquestionCounter") > 0) {
              
        } else {
          localStorage.setItem("LCquestionCounter", 0);
        }
        } 
    ...
    <?php if ($done == 0) { ?>
        var temp = localStorage.getItem("LCquestionCounter");
        var int_questionCounter = parseInt(temp);
        int_questionCounter ++;
        localStorage.setItem("LCquestionCounter", int_questionCounter);
        $( "#questionCount" ).html(localStorage.getItem("LCquestionCounter"));
    <?php } ?>
...
/*        $.fn.addAns = function() {
        ...
        $( "#AnswerForm" ).on( "submit", function( event ) {
          ...
          if (b == userAnswer) {
            ...
            var store = localStorage.getItem("LCuserMark");
            var int_userMark = parseInt(store);
            int_userMark ++;
            localStorage.setItem("LCuserMark", int_userMark);
        ...
        <div class="col-sm-6 response_col">
          ...
          <div class="userMarkDisplay">
            <small> Number of Questions Correct: <span id="currentMark"></span></small>
                <script>
                  currentMark_int = parseInt(localStorage.getItem("LCuserMark"));
